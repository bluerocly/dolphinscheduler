    ...
    <m-list-box>
      ...
      <div slot="content">
        <el-input
          ...
          size="small"
          v-model="appName"
          :placeholder="$t('Please enter app name(required)')">
        </el-input>
        <span>({{$t('app name extend info')}})</span>
      </div>
    </m-list-box>
    <m-list-4-box>
  ...
  export default {
    ...
    methods: {
      ...
      _verification () {
        ...
        if (!this.appName) {
          this.$message.warning(`${i18n.$t('Please enter app name')}`)
          return false
        }
    ...
    components: { mLocalParams, mListBox, mList4Box, Treeselect, mStatementList, mUdfs }
  }
</script>
