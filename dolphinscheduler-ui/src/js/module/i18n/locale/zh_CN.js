...
export default {
  ...
  'SQL Parameter': 'sql参数',
  'SQL Statement': 'sql语句',
  'Please enter a Message Template(required)': '请输入消息模板（必填）',
  'UDF Function': 'UDF函数',
  ...
  Queue: '队列',
  'Queue name': '队列名称',
  'Please enter a queueName(required)': '请输入队列名称（必填）',
  ...
  Project: '项目',
  'Project Extend': '项目 （搜索包括项目名称和项目里的工作流名称）',
  Authorize: '授权',
  'File resources': '文件资源',
  'UDF resources': 'UDF资源',
  ...
  'Alarm group': '告警组',
  'Please enter a Alarm group(required)': '请选择告警组（必填）',
  'Dependent model name': '依赖模型名称',
  'Dependent model name is a required field': '依赖模型名称为必填项',
  'Time substitution variable': '时间替换变量名',
  'Message driven status': '消息驱动状态',  
  ...
  'Process Instance Running Count': '正运行流程数',
  'Process Instance Failure Count': '失败流程数',
  'Task Instance Failure Count': '失败任务数',
