...
export default {
  ...
  'App Name': 'App Name',
  'Please enter app name(required)': 'Please enter app name(required)',
  'Please enter app name': 'Please enter app name',
  'app name extend info': 'timer task, add time parameter',
  'SQL Type': 'SQL Type',
  ...
  'Please enter a Message Template(required)': 'Please enter a Message Template(required)',
  ...
  'Please enter a queueName(required)': 'Please enter a queueName(required)',
  ...
  Project: 'Project',
  'Project Extend': 'Project(Search contain project name and process name)',
  Authorize: 'Authorize',
  ...
  'Dependent model name': 'dependent model name',
  'Dependent model name is a required field': 'dependent model name is a required field',
  'Time substitution variable': 'Time substitution variable',
  'Message driven status': 'Message driven status',
  'Please enter a Alarm group(required)': 'Please enter a Alarm group(required)',
  ...
  'FTP compress example': 'suffix needs to set',
  ...
  'Push Start Process': 'Push Start Process',
  ...
  'Process Instance Failure Count': 'Process Instance Failure Count',
  'Task Instance Failure Count': 'Task Instance Failure Count',
