...
public class TaskConstants {
     ...
     * datax 解析日志
     */
    public static final String TASK_DATAX_START_TIME_SUFFIX = "任务启动时刻";
    public static final String TASK_DATAX_END_TIME_SUFFIX = "任务结束时刻";
    public static final String TASK_DATAX_TOTAL_TIME_SUFFIX = "任务总计耗时";
    public static final String TASK_DATAX_AVERAGE_FLOW_SUFFIX = "任务平均流量";
    ...
    public static final String TASK_TOTAL_TIME = "task_total_time";
    public static final String TASK_AVERAGE_FLOW = "task_average_flow";
