 ...
 */
public interface CommandPushWaitingMapper extends BaseMapper<CommandPushWaiting> {

    /**
     * query command page
     * @return
     */
    List<CommandPushWaiting> queryCommandPage(@Param("limit") int limit, @Param("offset") int offset);

	List<CommandPushWaiting> queryWaitingCommand();
